...
export const flowsMockExecutions: WorkflowExecutionSummary[] = [
  {
    ...
    failedAt: null,
    updatedAt: "2026-05-23T08:02:05Z",
  },
  {
...
export const flowsMockExecutionDetails: WorkflowExecutionDetail[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        startedAt: "2026-05-23T08:02:03Z",
        completedAt: "2026-05-23T08:02:04Z",
        failedAt: null,
        updatedAt: "2026-05-23T08:02:04Z",
      },
      {
        stepExecutionId: "wfs_search",
        stepKey: "request-search-indexing",
        stepName: "Request search indexing",
        actionType: "request_search_indexing",
        status: "completed",
        retryCount: 0,
        failureReason: null,
        input: { triggerType: "event", sourceEventId: "evt_ocr_completed" },
        output: { searchDocumentId: "srch_123", status: "pending" },
        startedAt: "2026-05-23T08:02:04Z",
        completedAt: "2026-05-23T08:02:05Z",
        failedAt: null,
        updatedAt: "2026-05-23T08:02:05Z",
      },
